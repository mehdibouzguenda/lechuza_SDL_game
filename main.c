...
int main() {
    ...
    chargerTous(&ecran, &star, &shab1, &shab2, &shab3, &menu, &texteplay, &textemulti, &texteoption, &textequit,
                &musique, &effet, &sonspell, &dying, &hit, &effet2, &police, &police1, couleur);
    intro(&ecran);
    remplirlesposition(&positionFond, &posquit, &posmulti, &posoption, &posplay, &posstar, &poscquit, &poscmulti,
                       &poscoption, &poscplay, &posshab1, &posshab2, &posshab3, &posvolb);
