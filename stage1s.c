...
//stage1
void
stage1s(SDL_Surface *ecran, int *continuer, Mix_Music *intro, Mix_Chunk *effet, Mix_Chunk *effet2, Mix_Music *musique,
        int *mute, SDL_Rect *posvolb, Mix_Chunk *sonspell, Mix_Chunk *dying, Mix_Chunk *hit, int *victory) {
    ...
    TTF_Font *fonts = NULL;
    SDL_TimerID timer;
    fonts = TTF_OpenFont("fonts/BLKCHCRY.TTF", 60);
    ...
    /*for (i=0; i<400;i++)
		...
		SDL_Delay(3000);*/
    //position Tous
    charger(&poshero.x, &posmagicien.x, &posenigme1.x, &poshpup.x, &posback.x, &pospolice.x, &pose1, &pose2, &pose3,
            &pose4, &pose5, &pose6, &pose7, &posrock1.x, &postrap1.x, &posterre3.x, &posterre1.x, &posterre2.x,
            &posterre4.x, &posterre5.x, &posterre6.x, &posterre7.x, &posterre8.x, &posterre9.x, &camera, continuer,
            &stage, &tsec, &tmin, &hp, &cmpsc);
    ...
    while ((boucle) && ((*continuer))) {
            ...
            switch (event.type) {
                ...
                case SDL_KEYDOWN:
                    switch (event.key.keysym.sym) {
                        ...
                        case SDLK_ESCAPE:
                            Pause1(ecran, &poshero.x, &posmagicien.x, &posenigme1.x, &poshpup.x, &posback.x,
                                   &pospolice.x, &posenemie1, &posenemie2, &posenemie3, &posenemie4, &posenemie5,
                                   &posenemie6, &posenemie7, &posrock1.x, &postrap1.x, &posterre3.x, &posterre1.x,
                                   &posterre2.x, &posterre4.x, &posterre5.x, &posterre6.x, &posterre7.x, &posterre8.x,
                                   &posterre9.x, &camera, continuer, tsec, tmin, hp, cmpsc);
                            break;
        ...
        if (keystates[SDLK_d])//right
        {
            ...
            if (coll == 0) {
                scrolling(&poshero.x, &posmagicien.x, &posenigme1.x, &poshpup.x, &posback.x, &pospolice.x, &pose1.x,
                          &pose2.x, &pose3.x, &pose4.x, &pose5.x, &pose6.x, &pose7.x, &posrock1.x, &postrap1.x,
                          &posterre3.x, &posterre1.x, &posterre2.x, &posterre4.x, &posterre5.x, &posterre6.x,
                          &posterre7.x, &posterre8.x, &posterre9.x, &camera, &ecran, &heroactu, directionhero);
            } else {
                poshero.x += speed;
            }
        ...
        if (keystates[SDLK_j] && intspell == 0 &&
            (jump == 0 || CAR1 == 1 || CAR2 == 1 || CAR3 == 1 || CAR4 == 1 || CAR5 == 1 || CAR6 == 1 || CAR7 == 1 ||
             CAR8 == 1 || CAR9 == 1 || CAR10 == 1))//attack
        {
            if (directionhero == 1) {
        ...
        } else if (jump == 2 && CAR1 == 0 && CAR2 == 0 && CAR3 == 0 && CAR4 == 0 && CAR5 == 0 && CAR6 == 0 &&
                   CAR7 == 0 && CAR8 == 0 && CAR9 == 0 && CAR10 == 0) {
            if (directionhero == 1)
                animation(&heroactu, jumpr, &i);
            if (directionhero == 2)
                animation(&heroactu, jumpl, &i);
        ...
        if ((collision(poshero, posenemie1) == 1 || collision(poshero, posenemie2) == 1 ||
             collision(poshero, posenemie3) == 1 || collision(poshero, posenemie4) == 1) ||
            collision(poshero, posenemie5) == 1 || collision(poshero, posenemie6) == 1 ||
            collision(poshero, posenemie7) == 1) {
            if (cmpsc != 0)
                cmpsc -= 5;
            if (hp != 0)
                hp--;
        ...
        if (collision(poshero, posterre1) == 1 && (jump == 2 || jump == 1) &&
            (poshero.y + poshero.h > posterre1.y + speed)) {
            if (directionhero == 1) {
                poshero.x -= speed;
                camera -= speed;
            }
        ...
        if (collision(poshero, posterre2) == 1 && (jump == 2 || jump == 1) &&
            (poshero.y + poshero.h > posterre2.y + speed)) {
            if (directionhero == 1) {
                poshero.x -= speed;
                camera -= speed;
            }
        ...
        if (collision(poshero, posterre3) == 1 && (jump == 2 || jump == 1) &&
            (poshero.y + poshero.h > posterre3.y + speed)) {
            if (directionhero == 1) {
                poshero.x -= speed;
                camera -= speed;
            }
        ...
        if (collision(poshero, posterre4) == 1 && (jump == 2 || jump == 1) &&
            (poshero.y + poshero.h > posterre4.y + speed)) {
            if (directionhero == 1) {
                poshero.x -= speed;
                camera -= speed;
            }
        ...
        if (collision(poshero, posterre5) == 1 && (jump == 2 || jump == 1) &&
            (poshero.y + poshero.h > posterre5.y + speed)) {
            if (directionhero == 1) {
                poshero.x -= speed;
                camera -= speed;
            }
        ...
        if (collision(poshero, posterre6) == 1 && (jump == 2 || jump == 1) &&
            (poshero.y + poshero.h > posterre6.y + speed)) {
            if (directionhero == 1) {
                poshero.x -= speed;
                camera -= speed;
            }
        ...
        if (collision(poshero, posterre7) == 1 && (jump == 2 || jump == 1) &&
            (poshero.y + poshero.h > posterre7.y + speed)) {
            if (directionhero == 1) {
                poshero.x -= speed;
                camera -= speed;
            }
        ...
        if (collision(poshero, posterre8) == 1 && (jump == 2 || jump == 1) &&
            (poshero.y + poshero.h > posterre8.y + speed)) {
            if (directionhero == 1) {
                poshero.x -= speed;
                camera -= speed;
            }
        ...
        if (collision(poshero, posterre9) == 1 && (jump == 2 || jump == 1) &&
            (poshero.y + poshero.h > posterre9.y + speed)) {
            if (directionhero == 1) {
                poshero.x -= speed;
                camera -= speed;
            }
        ...
        if (hp == 0 || (*victory) != 2) {
            ...
            fonts = TTF_OpenFont("fonts/BLKCHCRY.TTF", 90);
