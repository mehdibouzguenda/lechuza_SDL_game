...
void
scrolling2(Sint16 *poshero, Sint16 *posmagicien, Sint16 *posenigme1, Sint16 *poshpup, Sint16 *poshpup1, Sint16 *posback,
           Sint16 *pospolice, Sint16 *pose1, Sint16 *pose2, Sint16 *pose3, Sint16 *pose4, Sint16 *pose5, Sint16 *pose6,
           Sint16 *pose7, Sint16 *pose8, Sint16 *posrock1, Sint16 *postrap1, Sint16 *posterre3, Sint16 *posterre1,
           Sint16 *posterre2, Sint16 *posterre4, Sint16 *posterre5, Sint16 *posterre6, Sint16 *posterre7,
           Sint16 *posterre8, Sint16 *posterre9, Sint16 *posninjaa, int *camera, SDL_Surface **ecran,
           SDL_Surface **heroactu, int e) {
    if (e == 1) {
        (*camera) += speed;
        (*poshero) += speed;
...
void
scrolling(Sint16 *poshero, Sint16 *posmagicien, Sint16 *posenigme1, Sint16 *poshpup, Sint16 *posback, Sint16 *pospolice,
          Sint16 *pose1, Sint16 *pose2, Sint16 *pose3, Sint16 *pose4, Sint16 *pose5, Sint16 *pose6, Sint16 *pose7,
          Sint16 *posrock1, Sint16 *postrap1, Sint16 *posterre3, Sint16 *posterre1, Sint16 *posterre2,
          Sint16 *posterre4, Sint16 *posterre5, Sint16 *posterre6, Sint16 *posterre7, Sint16 *posterre8,
          Sint16 *posterre9, int *camera, SDL_Surface **ecran, SDL_Surface **heroactu, int e) {
    if (e == 1) {
        (*camera) += speed;
        (*poshero) += speed;
...
int collision(SDL_Rect hero, SDL_Rect autre) {
    if ((autre.x <= hero.x + hero.w) && (autre.x + autre.w >= hero.x) && (autre.y <= hero.y + hero.h) &&
        (autre.y + autre.h >= hero.y))
        return 1;
    else
        return 0;
}
...
void chargerTous(SDL_Surface **ecran, SDL_Surface **star, SDL_Surface **shab1, SDL_Surface **shab2, SDL_Surface **shab3,
                 SDL_Surface **menu, SDL_Surface **texteplay, SDL_Surface **textemulti, SDL_Surface **texteoption,
                 SDL_Surface **textequit, Mix_Music **musique, Mix_Chunk **effet, Mix_Chunk **sonspell,
                 Mix_Chunk **dying, Mix_Chunk **hit, Mix_Chunk **effet2, TTF_Font **police, TTF_Font **police1,
                 SDL_Color couleur) {
    ...
    SDL_WM_SetCaption("lechuza", NULL);
    ...
    (*police) = TTF_OpenFont("fonts/BLKCHCRY.TTF", 70);
...
void remplirlesposition(SDL_Rect *positionFond, SDL_Rect *posquit, SDL_Rect *posmulti, SDL_Rect *posoption,
                        SDL_Rect *posplay, SDL_Rect *posstar, SDL_Rect *poscquit, SDL_Rect *poscmulti,
                        SDL_Rect *poscoption, SDL_Rect *poscplay, SDL_Rect *posshab1, SDL_Rect *posshab2,
                        SDL_Rect *posshab3, SDL_Rect *posvolb) {
    posvolb->x = 660;
    posvolb->y = 363;
    posshab1->x = 10;
    posshab1->y = 40;
...
void affichagetextmenu(TTF_Font **police, TTF_Font **police1, SDL_Color couleur, SDL_Color couleur2, SDL_Event event,
                       SDL_Surface **texteplay, SDL_Surface **textemulti, SDL_Surface **texteoption,
                       SDL_Surface **textequit, SDL_Surface **commentaireplay, SDL_Surface **commentaireoption,
                       SDL_Surface **commentairemulti, SDL_Surface **commentairequit, Mix_Chunk *effet, int *son,
                       int *mute) {
    FILE *fichier = NULL;
...
void
buttons(SDL_Surface *ecran, SDL_Event event, Mix_Chunk *effet, Mix_Chunk *effet2, int *continuer, Mix_Music *musique,
        int *mute, SDL_Rect *posvolb, Mix_Music *intro, Mix_Chunk *sonspell, Mix_Chunk *dying, Mix_Chunk *hit,
        int *victory) {
    int boucle;
    FILE *fichier = NULL;
    int e = 0;
    if (event.button.button == SDL_BUTTON_LEFT && event.motion.x < 500 && event.motion.x > 120 &&
        event.motion.y < 290 && event.motion.y > 200) {
        bouton_newgame(ecran, event, effet, effet2, continuer, musique, mute, posvolb, intro, sonspell, dying, hit,
                       victory);
    }
    if (event.button.button == SDL_BUTTON_LEFT && event.motion.x < 450 && event.motion.x > 120 &&
        event.motion.y < 400 && event.motion.y > 340) {
    ...
    if (event.button.button == SDL_BUTTON_LEFT && event.motion.x < 385 && event.motion.x > 120 &&
        event.motion.y < 520 && event.motion.y > 450) {
        if ((*mute) == 0) {
            Mix_PlayChannel(-1, effet2, 0);
        }
        option(ecran, effet, effet2, musique, mute, continuer, posvolb);
    } else if (event.button.button == SDL_BUTTON_LEFT && event.motion.x < 320 && event.motion.x > 120 &&
               event.motion.y < 640 && event.motion.y > 560) {
        if ((*mute) == 0) {
            Mix_PlayChannel(-1, effet2, 0);
        }
        (*continuer) = 0;
...
void
buttons1(SDL_Surface *ecran, SDL_Event event, Mix_Chunk *effet, Mix_Chunk *effet2, int *continuer, Mix_Music *musique,
         int *mute, SDL_Rect *posvolb, Mix_Music *intro, Mix_Chunk *sonspell, Mix_Chunk *dying, Mix_Chunk *hit,
         int *victory) {
    int e = 0;
    FILE *fichier = NULL;
    switch (event.key.keysym.sym) {
        ...
        case SDLK_KP2:
            ...
            if (fichier != NULL) {
                fscanf(fichier, "%d", &e);
                if (e == 1) {
                    stage1s(ecran, continuer, intro, effet, effet2, musique, mute, posvolb, sonspell, dying, hit,
                            victory);
                    if ((*victory) == 1) {
                        stage2(ecran, continuer, intro, effet, effet2, musique, mute, posvolb, sonspell, dying, hit,
                               victory);
                    ...
                    stage2s(ecran, continuer, intro, effet, effet2, musique, mute, posvolb, sonspell, dying, hit,
                            victory);
                    /*if ((*victory)==1)
    						{
    							stage3
...
void positionshab(SDL_Rect *posshab1, SDL_Rect *posshab2, SDL_Rect *posshab3, int *direction, int *direction2,
                  int *direction3) {
...
void bouton_newgame(SDL_Surface *ecran, SDL_Event event, Mix_Chunk *effet, Mix_Chunk *effet2, int *continuer,
                    Mix_Music *musique, int *mute, SDL_Rect *posvolb, Mix_Music *intro, Mix_Chunk *sonspell,
                    Mix_Chunk *dying, Mix_Chunk *hit, int *victory) {
                ...
                case SDL_KEYDOWN:
                    switch (event.key.keysym.sym) {
                        case SDLK_KP1:
                            ...
                            if (*continuer == 1) {
                                stage1(ecran, continuer, intro, effet, effet2, musique, mute, posvolb, sonspell, dying,
                                       hit, victory);
                            }
                            if ((*victory) == 1) {
                                stage2(ecran, continuer, intro, effet, effet2, musique, mute, posvolb, sonspell, dying,
                                       hit, victory);
                            }
                            break;
...
void
Pause1(SDL_Surface *ecran, Sint16 *poshero, Sint16 *posmagicien, Sint16 *posenigme1, Sint16 *poshpup, Sint16 *posback,
       Sint16 *pospolice, SDL_Rect *pose1, SDL_Rect *pose2, SDL_Rect *pose3, SDL_Rect *pose4, SDL_Rect *pose5,
       SDL_Rect *pose6, SDL_Rect *pose7, Sint16 *posrock1, Sint16 *postrap1, Sint16 *posterre3, Sint16 *posterre1,
       Sint16 *posterre2, Sint16 *posterre4, Sint16 *posterre5, Sint16 *posterre6, Sint16 *posterre7, Sint16 *posterre8,
       Sint16 *posterre9, int *camera, int *continuer, int tsec, int tmin, int hp, int cmpsc) {
...
void
Pause2(SDL_Surface *ecran, Sint16 *poshero, Sint16 *posmagicien, Sint16 *posenigme1, Sint16 *poshpup, Sint16 *posback,
       Sint16 *pospolice, SDL_Rect *pose1, SDL_Rect *pose2, SDL_Rect *pose3, SDL_Rect *pose4, SDL_Rect *pose5,
       SDL_Rect *pose6, SDL_Rect *pose7, Sint16 *posrock1, Sint16 *postrap1, Sint16 *posterre3, Sint16 *posterre1,
       Sint16 *posterre2, Sint16 *posterre4, Sint16 *posterre5, Sint16 *posterre6, Sint16 *posterre7, Sint16 *posterre8,
       Sint16 *posterre9, int *camera, int *continuer, int tsec, int tmin, int hp, int cmpsc, Sint16 *posninja,
...
void
charger(Sint16 *poshero, Sint16 *posmagicien, Sint16 *posenigme1, Sint16 *poshpup, Sint16 *posback, Sint16 *pospolice,
        SDL_Rect *pose1, SDL_Rect *pose2, SDL_Rect *pose3, SDL_Rect *pose4, SDL_Rect *pose5, SDL_Rect *pose6,
        SDL_Rect *pose7, Sint16 *posrock1, Sint16 *postrap1, Sint16 *posterre3, Sint16 *posterre1, Sint16 *posterre2,
        Sint16 *posterre4, Sint16 *posterre5, Sint16 *posterre6, Sint16 *posterre7, Sint16 *posterre8,
        Sint16 *posterre9, int *camera, int *continuer, int *stage, int *tsec, int *tmin, int *hp, int *cmpsc) {
...
void
charger2(Sint16 *poshero, Sint16 *posmagicien, Sint16 *posenigme1, Sint16 *poshpup, Sint16 *posback, Sint16 *pospolice,
         SDL_Rect *pose1, SDL_Rect *pose2, SDL_Rect *pose3, SDL_Rect *pose4, SDL_Rect *pose5, SDL_Rect *pose6,
         SDL_Rect *pose7, Sint16 *posrock1, Sint16 *postrap1, Sint16 *posterre3, Sint16 *posterre1, Sint16 *posterre2,
         Sint16 *posterre4, Sint16 *posterre5, Sint16 *posterre6, Sint16 *posterre7, Sint16 *posterre8,
         Sint16 *posterre9, int *camera, int *continuer, int *stage, int *tsec, int *tmin, int *hp, int *cmpsc,
         Sint16 *posninja, SDL_Rect *pose8, Sint16 *poshpup1, Sint16 *posninjaa) {
