...
void
Multi(SDL_Surface *ecran, int *continuer, Mix_Music *intro, Mix_Chunk *effet, Mix_Chunk *effet2, Mix_Music *musique,
      int *mute, SDL_Rect *posvolb, Mix_Chunk *sonspell, Mix_Chunk *dying, Mix_Chunk *hit) {
    SDL_Surface *background = NULL, *animwitch = NULL, *background2 = NULL, *blackground = NULL, *spell = NULL, *spellen = NULL, *enemieattackl = NULL, *enemieattackr = NULL, *enemieidler = NULL, *enemieidlel = NULL, *gif[8] = {
            NULL}, *Gif = NULL, *hurt = NULL, *witch = NULL, *witchattack = NULL, *witchd = NULL, *witchg = NULL, *attackr = NULL, *attackl = NULL, *herod = NULL, *herog = NULL, *heroactu = NULL, *ennemie = NULL, *ennemied = NULL, *ennemieg = NULL, *idlel = NULL, *idler = NULL, *bande = NULL;
    ...
    animwitch = SDL_LoadBMP("image/enemies/lechuza.bmp");
    SDL_Event event;
